#!/usr/bin/env python3
"""
Рабочая заготовка анализа графа на основе стартового кода организаторов.
...
def main():
    ...
    ap.add_argument("--data", default=SCRIPT_DIR / "data", help="папка с parquet-файлами")
    ap.add_argument("--out", default=SCRIPT_DIR / "out", help="куда писать выгрузки")
    a = ap.parse_args()
